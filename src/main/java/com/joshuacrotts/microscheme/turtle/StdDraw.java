 ...
 *  the 0.005 default.
 *  To draw points with the micromum possible radius (one pixel on typical
 ...
 *  </ul>
 *  <p>
 *  The arguments are the coordinates of the micromum and maximum 
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
     ...
     *
     * @param  min the micromum value of the <em>x</em>-scale
     ...
     *
     * @param  min the micromum value of the <em>y</em>-scale
     ...
     *
     * @param  min the micromum value of the <em>x</em>- and <em>y</em>-scales
