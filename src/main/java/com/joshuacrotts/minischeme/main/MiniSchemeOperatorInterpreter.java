...
public class MiniSchemeOperatorInterpreter {
    ...
    protected static LValue interpretPrimitiveUnaryOperator(final int opType, final LValue lhs) throws MSSemanticException {
        switch (opType) {
            ...
            default: throw new MSSemanticException("invalid unary operator type " + opType);
        }
    }
    ...
    protected static LValue interpretPrimitiveBinaryOperator(int opType, LValue lhs, LValue rhs) throws MSSemanticException {
        switch (opType) {
            ...
            default: throw new MSSemanticException("invalid binary operator type " + opType);
        }
    }
    ...
    protected static LValue interpretPrimitiveTernaryOperator(final int opType, final LValue op1,
                                                              final LValue op2, final LValue op3) {
        switch (opType) {
            case MiniSchemeParser.STRSUBSTR: return new LValue(op1.getStringValue().substring((int) op2.getDoubleValue(), (int) op3.getDoubleValue()));
            default: throw new MSInterpreterException("Invalid primitive ternary operator " + opType);
        }
    }
    ...
    protected static LValue interpretPrimitiveNaryOperator(final int opType, final LValue lhs, final LValue rhs) {
        switch (opType) {
            ...
            default: throw new MSInterpreterException("Invalid primitive n-ary operator " + opType);
        }
    }
    ...
    private static LValue interpretSin(final LValue lhs) throws MSArgumentMismatchException {
        if (!lhs.isLNumber()) { throw new MSArgumentMismatchException("sin", "number", lhs.getType().toString()); }
    ...
    private static LValue interpretCos(final LValue lhs) throws MSArgumentMismatchException {
        if (!lhs.isLNumber()) { throw new MSArgumentMismatchException("cos", "number", lhs.getType().toString()); }
    ...
    private static LValue interpretTan(final LValue lhs) throws MSArgumentMismatchException {
        if (!lhs.isLNumber()) { throw new MSArgumentMismatchException("tan", "number", lhs.getType().toString()); }
    ...
    private static LValue interpretAsin(final LValue lhs) throws MSArgumentMismatchException {
        if (!lhs.isLNumber()) { throw new MSArgumentMismatchException("asin", "number", lhs.getType().toString()); }
    ...
    private static LValue interpretAcos(final LValue lhs) throws MSArgumentMismatchException {
        if (!lhs.isLNumber()) { throw new MSArgumentMismatchException("acos", "number", lhs.getType().toString()); }
    ...
    private static LValue interpretAtan(final LValue lhs) throws MSArgumentMismatchException {
        if (!lhs.isLNumber()) { throw new MSArgumentMismatchException("atan", "number", lhs.getType().toString()); }
     ...
     * @param lhs
     * @return
     * @throws MSArgumentMismatchException if the LValue is not a number.
     */
    private static LValue interpretSinh(final LValue lhs) throws MSArgumentMismatchException {
        if (!lhs.isLNumber()) { throw new MSArgumentMismatchException("sinh", "number", lhs.getType().toString()); }
    ...
    private static LValue interpretCosh(final LValue lhs) throws MSArgumentMismatchException {
        if (!lhs.isLNumber()) { throw new MSArgumentMismatchException("cosh", "number", lhs.getType().toString()); }
    ...
    private static LValue interpretTanh(final LValue lhs) throws MSArgumentMismatchException {
        if (!lhs.isLNumber()) { throw new MSArgumentMismatchException("tanh", "number", lhs.getType().toString()); }
    ...
    private static LValue interpretSqrt(final LValue lhs) throws MSSemanticException {
        if (!lhs.isLNumber()) { throw new MSArgumentMismatchException("sqrt", "number", lhs.getType().toString()); }
        else if (lhs.getDoubleValue() < 0) { throw new MSSemanticException("cannot use sqrt on negative number " + lhs.getDoubleValue()); }
    ...
    private static LValue interpretRound(final LValue lhs) throws MSArgumentMismatchException {
        if (!lhs.isLNumber()) { throw new MSArgumentMismatchException("round", "number", lhs.getType().toString()); }
    ...
    private static LValue interpretCeiling(final LValue lhs) throws MSArgumentMismatchException {
        if (!lhs.isLNumber()) { throw new MSArgumentMismatchException("ceiling", "number", lhs.getType().toString()); }
    ...
    private static LValue interpretFloor(final LValue lhs) throws MSArgumentMismatchException {
        if (!lhs.isLNumber()) { throw new MSArgumentMismatchException("floor", "number", lhs.getType().toString()); }
    ...
    private static LValue interpretTruncate(final LValue lhs) throws MSArgumentMismatchException {
        if (!lhs.isLNumber()) { throw new MSArgumentMismatchException("truncate", "number", lhs.getType().toString()); }
    ...
    private static LValue interpretLogicalNot(final LValue lhs) throws MSArgumentMismatchException {
        if (!lhs.isLBool()) { throw new MSArgumentMismatchException("logical not", "boolean", lhs.getType().toString()); }
    ...
    private static LValue interpretCar(final LValue lhs) throws MSArgumentMismatchException {
        if (!lhs.isLList()) { throw new MSArgumentMismatchException("car", "list/pair", lhs.getType().toString()); }
        return new LValue(((MSListNode) lhs.getTreeValue()).getCar());
    }
    ...
    private static LValue interpretCdr(final LValue lhs) throws MSArgumentMismatchException {
        if (!lhs.isLList()) { throw new MSArgumentMismatchException("cdr", "list/pair", lhs.getType().toString()); }
        return new LValue(((MSListNode) lhs.getTreeValue()).getCdr());
    }
    ...
    private static LValue interpretNullFn(final LValue lhs) {
        return new LValue(lhs.isLList() && ((lhs.getTreeValue() == null) || ((MSListNode) lhs.getTreeValue()).isNull()));
    }
    ...
    private static LValue interpretPairFn(final LValue lhs) {
        return new LValue(lhs.getTreeValue() != null
                && !((MSListNode) lhs.getTreeValue()).isNull()
                && lhs.isLList());
    }
    ...
    private static LValue interpretStringLengthFn(final LValue lhs) throws MSArgumentMismatchException {
        if (!lhs.isLString()) { throw new MSArgumentMismatchException("string-length", "string", lhs.getType().toString()); }
    ...
    private static LValue interpretVectorLengthFn(final LValue lhs) throws MSArgumentMismatchException {
        if (!lhs.isLVector()) { throw new MSArgumentMismatchException("vector-length", "vector", lhs.getType().toString()); }
    ...
    private static LValue interpretNumberToStringFn(final LValue lhs) throws MSArgumentMismatchException {
        if (!lhs.isLNumber()) { throw new MSArgumentMismatchException("number->string", "number", lhs.getType().toString()); }
    ...
    private static LValue interpretStringToNumberFn(final LValue lhs) throws MSSemanticException {
        if (!lhs.isLString()) { throw new MSArgumentMismatchException("string->number", "string", lhs.getType().toString()); }
    ...
    private static LValue interpretListToStringFn(final LValue lhs) throws MSArgumentMismatchException {
        ...
        while (true) {
            ...
            if (curr == null || (curr.isList() && ((MSListNode) curr).isNull())) {
                break;
            } else if (!curr.isList()) {
                throw new MSArgumentMismatchException("list->string list", "char at index " + idx, curr.getNodeType().toString());
            }

            MSListNode list = (MSListNode) curr;
            if (!list.getCar().isChar()) {
                throw new MSArgumentMismatchException("list->string list", "char at index " + idx, curr.getNodeType().toString());
            }

            sb.append(list.getCar().getStringRep());
            curr = list.getCdr();
        }
    ...
    private static LValue interpretStringToListFn(final LValue lhs) throws MSArgumentMismatchException {
        if (!lhs.isLString()) { throw new MSArgumentMismatchException("string->list", "string", lhs.getType().toString()); }
        ...
        for (int i = str.length() - 1; i >= 0; i--) {
            ...
            prevList = new MSListNode(rchar, prevList);
        }
    ...
    private static LValue interpretToDegrees(final LValue lhs) throws MSArgumentMismatchException {
        if (!lhs.isLNumber()) { throw new MSArgumentMismatchException("to-degrees", "number", lhs.getType().toString()); }
    ...
    private static LValue interpretToRadians(final LValue lhs) throws MSArgumentMismatchException {
        if (!lhs.isLNumber()) { throw new MSArgumentMismatchException("to-radians", "number", lhs.getType().toString()); }
    ...
    private static LValue interpretRandomFn(final LValue lhs) throws MSArgumentMismatchException {
        if (!lhs.isLNumber()) { throw new MSArgumentMismatchException("random", "number", lhs.getType().toString()); }
    ...
    private static LValue interpretEqualFn(final LValue lhs, final LValue rhs) {
        if (lhs.getType() == rhs.getType()) {
            switch (lhs.getType()) {
                ...
                case VECTOR:
                case SYM:
                case LIST: return new LValue(lhs.toString().equals(rhs.toString()));
                case NULL: return new LValue(true);
                default: throw new MSInterpreterException("Cannot use equal? procedure on operands of type " + lhs.getType());
            }
        }
    ...
    private static LValue interpretModulo(final LValue lhs, final LValue rhs) throws MSArgumentMismatchException {
        if (!lhs.isLNumber()) { throw new MSArgumentMismatchException("modulo", "number", lhs.getType().toString()); }
        else if (!lhs.isLNumber()) { throw new MSArgumentMismatchException("modulo", "number", rhs.getType().toString()); }
    ...
    private static LValue interpretLogicalEq(final LValue lhs, final LValue rhs) throws MSArgumentMismatchException {
        if (!lhs.isLNumber()) { throw new MSArgumentMismatchException("=", "number", lhs.getType().toString());
        } else if (!lhs.isLNumber()) { throw new MSArgumentMismatchException("=", "number", rhs.getType().toString()); }
        return new LValue(lhs.getDoubleValue() == rhs.getDoubleValue());
    }
    ...
    private static LValue interpretStringEqFn(final LValue lhs, final LValue rhs) throws MSArgumentMismatchException {
        if (!lhs.isLString()) { throw new MSArgumentMismatchException("string=?", "string", lhs.getType().toString()); }
        else if (!lhs.isLString()) { throw new MSArgumentMismatchException("string=?", "string", rhs.getType().toString()); }
    ...
    private static LValue interpretStringLtFn(final LValue lhs, final LValue rhs) throws MSArgumentMismatchException {
        if (!lhs.isLString()) { throw new MSArgumentMismatchException("string<?", "number", lhs.getType().toString()); }
        else if (!lhs.isLString()) { throw new MSArgumentMismatchException("string<?", "number", rhs.getType().toString()); }
    ...
    private static LValue interpretVectorRefFn(final LValue lhs, final LValue rhs) throws MSSemanticException {
        if (!lhs.isLVector()) { throw new MSArgumentMismatchException("vector-ref", "vector", lhs.getType().toString()); }
        else if (!rhs.isLNumber()) { throw new MSSemanticException("cannot reference vector from non-integer index"); }
